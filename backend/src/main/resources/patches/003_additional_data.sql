-- =====================================================
-- Patch 003: Additional Data (Inventory + Orders)
-- Consolidated patch combining:
--   - Additional batches and inventory (IM-BLOOM, IM-WIRE-ROD, RM stock)
--   - 30 additional orders (IDs 16-45) with multi-stage products
--   - 332 operations (IDs 94-425)
--   - Audit trail entries
-- =====================================================

-- =====================================================
-- SECTION 1: Additional Intermediate Material Batches
-- =====================================================
...
-- =====================================================
-- SECTION 5: Additional Orders (30 new, IDs 16-45)
-- Includes multi-stage, mixed, and single-stage orders
-- =====================================================
...
-- Note: Line items for CANCELLED orders use CANCELLED status
-- =====================================================
...
SELECT v.* FROM (VALUES
  ...
  (35, 25, 'HR-COIL-2MM', 'Hot Rolled Coil 2mm', 240::numeric, 'T', '2026-03-12'::date, 'CANCELLED', 'SYSTEM'),
  ...
  (53, 34, 'HR-COIL-3MM', 'Hot Rolled Coil 3mm', 90::numeric, 'T', '2026-03-16'::date, 'CANCELLED', 'SYSTEM'),
  (54, 34, 'CR-SHEET-2MM', 'Cold Rolled Sheet 2mm', 80::numeric, 'T', '2026-03-16'::date, 'CANCELLED', 'SYSTEM'),
  (55, 34, 'REBAR-12MM', 'Reinforcement Bar 12mm', 140::numeric, 'T', '2026-03-14'::date, 'CANCELLED', 'SYSTEM'),
...
-- Reset batch and inventory sequences (orders/line_items/operations already reset above)
