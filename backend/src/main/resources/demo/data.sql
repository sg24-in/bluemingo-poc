...
-- Operations for Order 1, Line Item 18 (HR-COIL-3MM, 50T - was missing ops)
...
-- Operations for Order 2, Line Item 19 (CR-SHEET-2MM, 40T - was missing ops)
...
-- Operations for Order 3, Line Item 20 (REBAR-12MM, 100T - was missing ops)
...
-- Operations for Order 6, Line Item 21 (REBAR-12MM, 150T - was missing ops)
...
-- Operations for Order 9, Line Item 22 (HR-COIL-4MM, 100T - was missing ops)
...
ALTER TABLE operations ALTER COLUMN operation_id RESTART WITH 94;
...
-- =====================================================
-- STEP 22: Additional Orders (30 new orders with multi-stage products)
-- Includes 15 multi-stage, 4 mixed, 11 single-stage orders
-- =====================================================
...
-- Full Pipeline 4-Stage: All 4 processes (Billet + HR Coil + CR Sheet + Rebar) = 22 ops
...
-- Multi-stage: Order 29 (HR->CR) - COMPLETED
...
-- Multi-stage: Order 30 (Billet->Rebar) - COMPLETED
...
-- Multi-stage: Order 31 (Billet->Rebar)
...
-- Multi-stage: Order 32 (Billet->Rebar) - ON_HOLD
...
-- Multi-stage: Order 33 (Full Pipeline: HR+CR+Rebar) - IN_PROGRESS
...
-- Multi-stage: Order 34 (Full Pipeline) - CANCELLED
...
-- Multi-stage: Order 35 (Triple Process: Billet+HR+CR)
...
-- Mixed: Order 37 (Rebar variants) - COMPLETED
...
-- Mixed: Order 38 (CR Sheet variants) - IN_PROGRESS
...
-- Multi-stage: Order 39 (Heavy HR->CR) - COMPLETED
...
-- Multi-stage: Order 41 (Billet->Rebar)
...
-- Multi-stage: Order 42 (Full Pipeline 4-Stage: Billet+HR+CR+Rebar)
...
-- Mixed: Order 43 (HR variants) - COMPLETED
...
-- Multi-stage: Order 44 (Billet+Rebar+CR) - IN_PROGRESS
...
--   Equipment:              16
--   Operators:              12
--   Orders:                 45 (15 original + 30 new incl. 15 multi-stage)
--   Order Line Items:       82 (25 original + 57 new)
--   Operations:            425 (93 original + 332 new)
